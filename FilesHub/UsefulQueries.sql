...
sqlite3 FilesHub_old_2014-09-30_1412101888685.db -cmd ".width 15 3 125" -column -header "SELECT hash, COUNT(*), canonical_path FROM Trash GROUP BY hash, canonical_path HAVING COUNT(*) > 1;" =>>83+7
